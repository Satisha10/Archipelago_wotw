...
refills: dict[str, tuple[int, int, int]] = {  # key: region name. Tuple: [health restored, energy restored, refill type]
    ...
    "EastHollow.TreeAreaJumppad": (0, 0, 0),
    "EastHollow.DepthsLeverDoor": (0, 0, 0),
    ...
    "GladesTown.BuiltMotayHut": (0, 0, 0),
    "GladesTown.MotayHutDoor": (0, 0, 0),
    ...
    "WeepingRidge.AfterElementals": (0, 0, 0),
    ...
    "WillowsEnd.MiniBossFight": (1, 0, 1),
...
refill_events: list[str] = [
    ...
    "C.WestGlades.RightLowerPool",
    "E.WestGlades.RightLowerPool",
    "C.WestGlades.Center",
    "C.WestGlades.Upper",
    "H.WestGlades.Upper",
    ...
    "C.WeepingRidge.Elevator",
    "C.WeepingRidge.TopElevator",
    "H.WeepingRidge.TopElevator",

...
gem_recipies: dict[str, ItemData] = {
    ...
    "Chipped Edge Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-mel-str",
        item_type="Blueprint",
    ),
    "Bent Edge Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-mel-crit",
        item_type="Blueprint",
    ),
    ...
    "Shaggy Quill Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-rng-str",
        item_type="Blueprint",
    ),
    "Fickle Quill Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-rng-crit",
        item_type="Blueprint",
    ),
    "Dirty Quill Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-rng-spec",
        item_type="Blueprint",
    ),
    "Dim Halo Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-up-maj-l-def",
        item_type="Blueprint",
    ),
    "Vexed Halo Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-up-maj-l-off",
        item_type="Blueprint",
    ),
    ...
    "Crude Laurel Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-up-maj-r-off",
        item_type="Blueprint",
    ),
    "Flexing Bracer Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-mid-maj-l-off",
        item_type="Blueprint",
    ),
    "Stiff Bracer Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-mid-maj-l-def",
        item_type="Blueprint",
    ),
    "Ruffian's Gauntlet Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-mid-maj-r-off",
        item_type="Blueprint",
    ),
    ...
    "Brittle Shell Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-low-maj-l-def",
        item_type="Blueprint",
    ),
    "Light Shell Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-low-maj-l-off",
        item_type="Blueprint",
    ),
    "Simple Cuirass Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-low-maj-r-def",
        item_type="Blueprint",
    ),
    "Runner's Cuirass Blueprint": ItemData(
        classification=IC.useful,
        pool_quantity=0,
        game_name="bp-low-maj-r-off",
        item_type="Blueprint",
    ),
}
